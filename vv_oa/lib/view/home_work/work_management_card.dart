...
Widget getWorkManagementCard(BuildContext context) {
                    ...
                    child: new Container(
                      child: new Column(
                        children: <Widget>[
                          new Container(
                            child: new Text(
                              GlobalConfig.administrativeManagement,
                              style: new TextStyle(
                      ...
                      child: new Column(
                        children: <Widget>[
                          ...
                          new Container(
                            child: new Text(
                              GlobalConfig
                                  .administrativeManagementArticlesForUse,
                              style: new TextStyle(
                                  color: GlobalConfig.fontColor,
                                  fontSize: 14.0),
                            ),
                    ...
                    child: new Container(
                      child: new Column(
                        children: <Widget>[
                          ...
                          new Container(
                            child: new Text(
                                GlobalConfig.administrativeManagementCarApply,
                                style: new TextStyle(
                                    color: GlobalConfig.fontColor,
                                    fontSize: 14.0)),
                          )
