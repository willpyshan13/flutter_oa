...
class WidgetName2Icon {
  static Map<String,dynamic> icons = {
    "Center":Icons.explicit,
    "Settings":Icons.extension,
    "MyApplication":Icons.filter_b_and_w,
    "MyApproval":Icons.table_chart,
    "ProcessControl":Icons.aspect_ratio,
    "Dictionary":Icons.subscriptions,
    "CompanyList":Icons.input,
    "Department":Icons.text_fields,
    "Post":Icons.check_box,
    "Employee":Icons.playlist_add_check,
    "Permission":Icons.aspect_ratio,
    "Role":Icons.outlined_flag,
    "AttendanceCount":Icons.picture_in_picture_alt,
    "AttendanceList":Icons.import_contacts,
    "MyAttendance":Icons.power_input,
